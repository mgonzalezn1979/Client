...
function ProductoItemAdmin(producto) {
  ...
  const { URL_PATH_API, tiposProducto, listado, setListado, setMensajeria } =
    useContext(Context);
  ...
  return (
    <div class="row listado">
      ...
      <div
        class="alert alert-primary popup"
        role="danger"
        id="popup_mensajeria"
        hidden={mensajeriaLocal == "" ? true : false}
      >
        {mensajeriaLocal}
      </div>
      ...
      <div class="col-lg-4">
        {producto.producto.urlFoto ? (
          <img class="imagen_producto" src={producto.producto.urlFoto}></img>
        ) : null}
      </div>
      ...
      <div class="col-lg-5">
        ...
        <button class="boton_estandar" onClick={handleEliminar}>
          Eliminar
        </button>
        {!estadoModificar ? (
